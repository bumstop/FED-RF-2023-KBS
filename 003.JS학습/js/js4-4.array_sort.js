...
/*   
    ...
    -> 주의: 숫자를 비교해도 문자열로 비교하기 때문에 "25" 와 "100"
    중 25를 더 큰 데이터로 인식한다.
...
// console.log('숫자배열.sort() 오름차순(a-b):',arrNumber.sort((a,b) => a - b));
// console.log('숫자배열.sort() 내림차순(b-a):',arrNumber.sort((a,b) => b - a));
...
const showScreen = () =>
    (showNum.innerHTML = arrNumber
        .map((val) => `<img src="./images/num/num_0${val}.png">`)
        .join(""));
