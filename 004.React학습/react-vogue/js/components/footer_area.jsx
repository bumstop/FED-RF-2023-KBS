...
// 재활용 없이 다시 컴포넌트가 그려지는일은 없게됨! -> 중복실행하지 않는다!
            ...
            <div id="footer-area">
                <footer class="footer-area ibx common-area">
                    ...
                    <address className="addr">
                        {props.fsts}WWW.VOGUE.COM Ⓒ CONDÉNAST ASIA PACIFIC. INC. ALL
                        RIGHTS RESERVED. VOGUE.COM KOREA IS OPERATED BY DOOSAN MAGAZINE.
                    </address>
                    {/* 3-3.하단링크 */}
