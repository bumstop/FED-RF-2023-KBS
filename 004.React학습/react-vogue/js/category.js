...
function MainComponent() {
    ...
    const chgCat = (val) => {
        ...
        // 새로고침등 페이지 리로드시 처음 들어온 파라미터로 페이지가 변경되며 새로고침

        // 이유는 처음들어온 cat=카테고리명 때문임
        // 그래서 리액트 컴포넌트 업데이트시 상단 URL 마지막 cat키값을 실제 
        // 카테고리명으로 업데이트 해준다
        //  -> history객체는 window하위객체임
        // 이전페이지로 이동하기 history.back() 등
